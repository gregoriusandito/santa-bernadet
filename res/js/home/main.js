...
(function($) {
    ...
    var arm_nav_side_toggle_buttons,
        arm_radioline_width;
        // xv_ww = $(window).width();
    ...
    arm_nav_side_toggle_buttons = function () {
        
        if ( $('#js-mobile-menu').length < 1 ) {
            return;
        }
        
        var toggle_nav_side_buttons = function (e) {
            e.stopPropagation();
            e.preventDefault();
        ...
        $('#js-mobile-menu').each(function () {
            $(this).on( 'click', toggle_nav_side_buttons );
        });
        
    };

    $(document).ready(arm_nav_side_toggle_buttons);
    
    arm_radioline_width = function () {
        if( $('#MusesRadioPlayer-HTML5-player-0').length <= 0 ) {
            return;
        }
        
        $('#MusesRadioPlayer-HTML5-player-0').css('width','100%');
        
    };    
    
    $(document).ready(arm_radioline_width);
